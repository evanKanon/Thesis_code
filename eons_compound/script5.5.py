...
parser.add_argument('-hist', '--histograms', help='creation of histograms of distributions', action='store_true')
parser.add_argument('-snap','--snapshots', help='save snapshots of networks and edge weights', action='store_true')
parser.add_argument('-cr','--crazy', help='save all networks created by the analysis', action='store_true')
parser.add_argument('-d','--data', help='save data of metrics (HD and WHD) from the analysis', action='store_true')
...
title1='Comparison Between Hamming Distance (HD) and Euclidean Distance in Edge Space (EDES) [Thresholds 0.0-0.4] ('+str(nodes)+'Nodes) ('+str(hmi)+'Iterations)'
title2='Comparison Between Hamming Distance (HD) and Euclidean Distance in Edge Space (EDES) [Thresholds 0.5-1.0] ('+str(nodes)+'Nodes) ('+str(hmi)+'Iterations)'
...
plt.errorbar(listx, normal_WHD, yerr=[niqrWHD_down, niqrWHD_up], linewidth=5, label='EDES', color='k')
#plt.ylim(0,1)
...
title1='-ln(pvalue) for Hamming Distance (HD) and Euclidean Distance in Edge Space (EDES) ('+str(nodes)+' Nodes) ('+str(hmi)+' Iterations)'
plt.gcf().clear()
#plt.xticks(x, listx)
...
plt.plot(-np.log(resultsWHD), linewidth='5', label='pval_EDES', color='k')
plt.xlabel('Value of SD')
